...
![chat-head demo](/public/img/chat-head-demo.gif)
...
![breakdown of the drag gesture](/public/img/drag.gif)
...
![ghost image that appears while dragging on desktop](/public/img/ghost.gif)
